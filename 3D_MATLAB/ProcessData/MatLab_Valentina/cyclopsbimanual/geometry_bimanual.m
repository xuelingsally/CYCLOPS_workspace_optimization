...
function [r_tool,s,h1,h2,p_in,T_in,r_ee,p_ee,r1,r2,r3,r4,r5,r5_left,r6,r6_left,B,B_left,P,P_left,l,l_left,p_x_b]=geometry_bimanual(L_tool,d_tool,x_f,L,d_bal,d_feed)
...
p5_left=p_in'+R_in(1:3,1:3)*r5_left;
...
p6_left=p_in'+R_in(1:3,1:3)*r6_left;

% Matrix of the attachment point positions on the right tool
P=[p1,p2,p3,p4,p5,p6];

% Matrix of the attachment point positions on the left tool
P_left=[p1,p2,p3,p4,p5_left,p6_left];
