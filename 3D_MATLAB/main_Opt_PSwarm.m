...
%% PSwarm
fun = @(x) -my_objective_function3(x, W, f_ee, r_ee, phi_min, phi_max, t_min, t_max, taskspace_d/1000, radius_tool, radius_scaffold);
Problem = struct('Variables', 14, 'ObjFunction', fun, 'LB', eaB_min, 'UB', eaB_max);
